			...
			<div class="col-sm-8">
				...
				@foreach ($project_categories as $project_category)
					<section id="block-front-latest-news" class="block-content" data-color="darkblue">
						<div class="title-block">
							...
							<a href="{{ route('project_category', $project_category->id) }}" class="show-all">{{ __('frontend.buttons.show_all') }}</a>
						</div>
						<div class="content">
							<div class="row">
								<div class="col-lg-5">
				...
				<section id="block-front-latest-news" class="block-content" data-color="darkblue">
					<div class="title-block">
						...
						<a href="{{ route('activity_category', $activity_category->id) }}" class="show-all">{{ __('frontend.buttons.show_all') }}</a>
					</div>
					<div class="content">
						<div class="row">
							<div class="col-lg-5">
