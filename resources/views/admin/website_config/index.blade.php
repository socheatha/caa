		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<th>Description My</th>
					<th>Description Sa</th>
				</tr>
			</thead>
			<tbody>
				<tr>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									...
									<textarea type="color" class="form-control"></textarea>
								</div>
							</div>
						</div>
...
<!-- 
		...
		<br>
		<br>
		<a href="#" data-toggle="modal" data-target="#_modal_contact_and_social"><h4>Contact and Social <i class="fa fa-edit"></i></a></h4>
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					<th class="text-center">N&deg;</th>
		...
		<div class="modal fade" id="_modal_contact_and_social" tabindex="-1" role="dialog" aria-labelledby="main_menuModalLabel">
			<div class="modal-dialog" role="document" style="width: 60%;">
				<div class="modal-content" style="margin-top: 80px;">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="fa fa-times"></span></button>
