    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <div class="form-group {!! (($errors->has('index'))? 'has-error':'') !!}">
          ...
          {!! Form::text('index', ((isset($slide_show->index))? $slide_show->index : $index ), ['class' => 'form-control ','placeholder' => 'index','required']) !!}
      ...
      <div class="col-sm-9">
        <div class="form-group {!! (($errors->has('seo_keywords'))? 'has-error':'') !!}">
          ...
          {!! Form::text('seo_keywords', ((isset($slide_show->seo_keywords))? $slide_show->seo_keywords : '' ), ['class' => 'form-control ','placeholder' => 'seo keywords','required']) !!}
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('description'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('seo_description', ((isset($slide_show->seo_description))? $slide_show->seo_description : '' ), ['class' => 'form-control ','style' => ((!isset($slide_show))? 'height: 108px;' : 'height: 33px;'),'placeholder' => 'seo description','required']) !!}
    ...
    @slot('tab_en')
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('name_en'))? 'has-error':'') !!}">
          ...
          {!! Form::text('name_en', ((isset($slide_show))? $slide_show->name_en : '' ), ['class' => 'form-control ','placeholder' => 'name en','required']) !!}
      ...
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('short_desc_en'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('short_desc_en', ((isset($slide_show->short_desc_en))? $slide_show->short_desc_en : '' ), ['class' => 'form-control ','rows' => '3','placeholder' => 'short description in english','required']) !!}
      ...
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('detail_en'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('detail_en', ((isset($slide_show->detail_en))? $slide_show->detail_en : '' ), ['class' => 'form-control my-editor','id' => 'detail_en','placeholder' => 'detail in english','required']) !!}
    ...
    @slot('tab_kh')
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('name_kh'))? 'has-error':'') !!}">
          ...
          {!! Form::text('name_kh', ((isset($slide_show))? $slide_show->name_kh : '' ), ['class' => 'form-control ','placeholder' => 'name khmer']) !!}
      ...
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('description'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('short_desc_kh', ((isset($slide_show->short_desc_kh))? $slide_show->short_desc_kh : '' ), ['class' => 'form-control ','rows' => '3','placeholder' => 'short description in khmer']) !!}
      ...
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('detail_kh'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('detail_kh', ((isset($slide_show->detail_kh))? $slide_show->detail_kh : '' ), ['class' => 'form-control my-editor','id' => 'detail_kh','placeholder' => 'detail in khmer']) !!}
    ...
    @slot('tab_my')
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('name_my'))? 'has-error':'') !!}">
          ...
          {!! Form::text('name_my', ((isset($slide_show))? $slide_show->name_my : '' ), ['class' => 'form-control ','placeholder' => 'name malay']) !!}
      ...
      <div class="col-sm-12">
        <div class="form-group {!! (($errors->has('short_desc_my'))? 'has-error':'') !!}">
          ...
          {!! Form::textarea('short_desc_my', ((isset($slide_show->short_desc_my))? $slide_show->short_desc_my : '' ), ['class' => 'form-control ','rows' => '3','placeholder' => 'short description in malay']) !!}
